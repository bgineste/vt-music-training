...
export default function Edit(props) {
    ...
    const { "bloc-fichiers-de-travail/cheminFichiers": cheminFichiersBloc } = context;
    const { cheminFichiers, typeFichiers, affichageClavier, fichierStereo } = attributes;

    const ALLOWED_BLOCKS = [  'vt-music-training/un-groupe-de-pupitres' ] // supprimer core/paragraph ?
            ...
            {props.isSelected ? (
                <div className="vt--editor-bloc-pupitres">
					...
					<div className="vt--editor-params-defaut-pupitres">
						<h2>Paramètres par défaut des fichiers "Pupitres"</h2>
						<TextControl
						...
						<p>Insérer ici un-groupe-de-pupitres (il peut y en avoir plusieurs ou un seul)</p>
						<InnerBlocks
							allowedBlocks= { ALLOWED_BLOCKS }
							placeholder="Ajoutez vos groupes de pupitres ici"
						/>
					</div>
				</div>
            ) : (

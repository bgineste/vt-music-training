...
export default function Edit( props ) {
	...
	const onChangeText = event => {
		...
		props.setAttributes( { interprete: texte } )
		console.log(props)
	}
	/*const onBlurCaract = event => {
		console.log("#####")
		let caract = event.target.value
		let nom = event.target.name
		props.attributes.caracteristiques[nom] = caract
		console.log(props.attributes.caracteristiques[nom])
	}*/
...
//		console.log(arg)
				...
				<>
					{
								...
								<label>Interprete<br />
								<input type='text' name='interprete' value={props.attributes.interprete}  onChange={ onChangeText } placeholder={ __('Write a text!', 'vt-music-training' ) } />
								</label> 
  ...
  console.log(key, props.attributes[key]);
					 ...
					 tableauInterpretation = Object.entries(props.attributes),
					 console.log('Tableau interprétation'),
					 console.log(tableauInterpretation),
					   
						  tableauInterpretation.map((item, index) => (

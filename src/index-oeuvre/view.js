...
function innerHTMLindexOeuvre(element) {
	...
	HTMLindex = HTMLindex + '<div class="vt--lien-vers-ancre" style="background-color: var(--vtmt--bg-symbole-fichier-de-travail);" onClick="this.closest(\'.vt--popup__support\').style.display=\'none\';">Retour</div>'
	return HTMLindex
}
